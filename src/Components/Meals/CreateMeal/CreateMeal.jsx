        ...
        <div>
            ...
            >
                ...
                <ModalBody>
                    ...
                    <Table><DisplayMeal nutroObj={nutroObj} fetchMeals={props.fetchMeals} toggleModal={props.toggleModal} displayInRightSpot={props.displayInRightSpot} category={props.category} userIdNow={props.userIdNow} mealCat={props.mealCat} sessionToken={props.sessionToken}/></Table>
                </ModalBody>
                <ModalFooter>
